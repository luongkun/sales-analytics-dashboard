...
export const VIP_TIERS: VipTierDef[] = [
  {
    ...
    min: 100_000,
    bonusPct: 5,
    /* Nâu đồng thật (bronze #8c6239 → nâu đậm #5c3a1d) — không còn tông cam */
    gradient: 'from-[#8c6239] to-[#5c3a1d]',
    text: 'text-[#8c6239] dark:text-[#c9a06c]',
    bar: 'from-[#8c6239] to-[#b08d57]',
    ring: 'ring-[#b08d57]/60',
    soft: 'border-[#b08d57]/60 dark:border-[#c9a06c]/25 bg-gradient-to-r from-[#8c6239]/10 to-[#b08d57]/5 dark:from-[#c9a06c]/10 dark:to-[#b08d57]/5',
    crown: 'text-[#8c6239] dark:text-[#c9a06c]',
